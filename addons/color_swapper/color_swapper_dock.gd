...
func _on_ImageColorTree_item_selected():
	...
	_image_preview.material.set_shader_parameter("selected_col_linear", col)
...
func _on_ImagePreview_mouse_entered():
	_image_preview.material.set_shader_parameter("cycle_enabled", true)


func _on_ImagePreview_mouse_exited():
	_image_preview.material.set_shader_parameter("cycle_enabled", false)
